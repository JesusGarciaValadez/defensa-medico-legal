...
@section( 'content' )
            <section class="internal clearfix content bit-1">
                ...
                <section class="clearfix advance bit-3">
                    {!! Html::image( 'img/home/gente-revisando-documentos.jpg', 'Gente revisando documentos', [ 'class' => 'bit-3' ] ) !!}
                    <p class="bit-666">¡Te quieren obligar a pagar año con año por ejercer tu profesión de por vida!<br />PROTEGETE CON NOSOTROS</p>
                </section>
                <section class="clearfix advance bit-3">
                    ...
                    <p class="bit-666">Las instancias más altas nos respaldan. La Ley es igual para todos y la justicia no tiene miramientos.</p>
                </section>
                <section class="clearfix advance bit-3">
                    ...
                    <p class="bit-666">Conoce los derechos y regulaciones que la comisión Interamericana ha desarrollado en pro de nosotros.</p>
                </section>
                <aside class="cleafix bit-1">
                    <p class="bit-1">AIDDEM busca proteger todos los intereses de los médicos de manera individual o de manera colectiva.</p>
                    <p class="bit-1">Individualmente  podemos conseguirte una suspensión de esta ley para que todo este tiempo que dura el amparo, tú no seas molestado y que cuando ganemos este amparo, definitivamente tú serás de los médicos que gocen que la ley no sea aplicada para ti.</p>
                </aside>
                <hr class="bit-1">
